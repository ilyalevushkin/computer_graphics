...
{
  public:
    virtual std::shared_ptr<Transformed_Model> buildModel(std::shared_ptr<Model> model, QColor& clr) = 0;
...
class Cylinder: public Transform_Tree
{
    public:
        ...
        std::shared_ptr<Transformed_Model> buildModel(std::shared_ptr<Model> model, QColor& clr) override;
